...
//   // ← नया: Page load पर fields खाली कर दो
//   useEffect(() => {
//     setFormData({
//       email: "",
//       password: "",
...
//           <div className="text-center mb-8">
//             <Link to="/" className="inline-block mb-6">
//               <div className="w-14 h-14 bg-gradient-to-br from-primary to-secondary rounded-lg flex items-center justify-cen
//               ter">
//                 <span className="text-white font-bold text-xl">HS</span>
//               </div>
//             </Link>
...
//             <p className="text-muted-foreground">Login to your HomeServe account</p>
//           </div>
...
//       login(loggedUser, `firebase_${user.uid}`);
...
//         description: "Popup blocked or authentication failed",
//         variant: "destructive",
//       });
//     }
//   }}
...
//           <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
//             <p className="text-sm text-blue-900">
//               <span className="font-semibold">Demo Mode:</span> Use any email and password to login.
//             </p>
//           </div>
//         </div>
//       </div>
...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      login(googleUser, `firebase_${user.uid}`);
      ...
      toast({
        title: "Google Login Failed",
        description: "Popup closed or auth error",
        variant: "destructive",
      });
    }
  };
