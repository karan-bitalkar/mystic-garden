...
// register.tsx
const API_URL = "http://13.60.231.82:5000";
...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("FORM DATA SEND HO RAHA HAI 👉", formData);
              ...
              <Button
                ...
                onClick={async () => {
                  try {
                    ...
                    const sessionId = `google_${user.uid}`;

                    register(googleUser, sessionId);
                    ...
                    toast({
                      ...
                      description: "Popup closed or authentication failed",
                      variant: "destructive",
                    });
                  }
                }}
